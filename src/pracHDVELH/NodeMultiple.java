...
public class NodeMultiple {
	...
	public NodeMultiple getDaughter(int i) {
		/* TO BE COMPLETED */
		if(i<0 || i>=NODE_MAX_ARITY){return ErrorNaiveHandler.abort(ERROR_MSG_INDEX_OUT_OF_RANGE + "@" + getClass() + ".getDaughters()");}
		return daughters[i];
	}
	...
	public void setDaughter(NodeMultiple daughter, int i) {
		...
		if(i<0 || i>=NODE_MAX_ARITY){
			ErrorNaiveHandler.abort(ERROR_STATUS_INDEX_OUT_OF_RANGE,ERROR_MSG_INDEX_OUT_OF_RANGE + "@" + getClass() + ".getDaughters()");
		}
